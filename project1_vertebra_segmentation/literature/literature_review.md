...
**Performance:** Lffler et al. (2020) - Multi-class VerSe segmentation achieves Dice 0.88-0.94 per-vertebra.
...
Encoder (downsampling with convolutions)
     Block 1: ConvReLUConv (16 features)
     MaxPool 2x2x2
     Block 2: ConvReLUConv (32 features)
     MaxPool 2x2x2
     Block 3: ConvReLUConv (64 features) [bottleneck]
    
Decoder (upsampling with deconvolutions)
     Upsample 2x2x2
     Concatenate with encoder skip connection (64+64 features)
     Block: ConvReLUConv (32 features)
     Upsample 2x2x2
     Concatenate with encoder skip (32+32 features)
     Block: ConvReLUConv (16 features)
...
**Key citations:**
- Lffler et al. (2020): VerSe dataset - primary benchmark
...
- iek et al. (2016): 3D U-Net - foundational architecture
