...
Final Conv Layer: 111 convolution  28 classes
...
- Patch size: 128128128 voxels (typical for A100 GPU)
...
Step 2: Ordinal Classification
 For each centroid, extract local feature region
   Extract 3D neighborhood (646464 around centroid)
...
- Typical volume size: 512512400 voxels = 200 MB uncompressed
...
Request Body:
{
  "dicom_url": "https://pacs.hospital.edu/wadooid=1.2.3",
...
- Training GPU memory: 24-32 GB (batch size 2, patch size 128128128)
